...
},
{
  ...
  bio: "Alice Umuhorakeye is the Mining Extraction and Inspection Division Manager at the Rwanda Mines, Petroleum and Gas Board (RMB), where she leads initiatives to promote sustainable mineral resource management, strengthen regulatory compliance, and advance responsible mining practices across Rwanda. Appointed by Cabinet in March 2026, she plays a key role in supporting the country's vision for sustainable and environmentally responsible development of its mining sector.\n\nWith more than a decade of professional experience in environmental management, Alice has built a distinguished career focused on natural resource protection, environmental impact assessment, climate change adaptation, and sustainable development. Prior to joining RMB, she served as a Technical Advisor at GIZ Rwanda from 2024 to 2026, where she supported the implementation of Rwanda's Nationally Determined Contributions (NDCs), aligning climate commitments with national policies while contributing to the development of climate financing frameworks and strategic partnerships.\n\nEarlier in her career, Alice served as a Water Quality Specialist at the Rwanda Water Resources Board from 2021 to 2024 and as an Environmental Protection Specialist with the City of Kigali from 2015 to 2021. Throughout these roles, she contributed to improving water quality management, strengthening environmental compliance, and advancing sustainable urban environmental planning.\n\nAlice holds a Master's degree in Environmental Economics and Natural Resources Management and a Bachelor's degree in Environmental Chemistry. She is also a certified Project Management Professional (PMP)®, combining strong technical expertise with internationally recognized project management skills.\n\nBeyond her professional responsibilities, Alice is an accomplished public speaker and moderator. In May 2025, she moderated Rwanda's first Climate Science Symposium, bringing together researchers, policymakers, and industry leaders to strengthen collaboration on climate resilience and sustainable development. Fluent in Kinyarwanda, English, and French, she is recognized for her ability to lead multidisciplinary teams, foster stakeholder engagement, and communicate complex environmental issues effectively.\n\nDriven by a passion for environmental stewardship and sustainable resource management, Alice continues to champion responsible mining, climate resilience, and policies that support Rwanda's long-term economic and environmental prosperity."
},
        ],
      },
    ],
