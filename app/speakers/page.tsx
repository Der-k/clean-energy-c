...
{
  name: "Prof. Emeka Emmanuel Oguzie",
  role: "Founder & Centre Leader, ACE-FUELS",
  organization: "Federal University of Technology Owerri (FUTO)",
  image: "/images/speakers/emeka-oguzie.jpeg",
  bio: "Professor Emeka Emmanuel Oguzie, FAS, is the Founder and Centre Leader of the Africa Centre of Excellence in Future Energies and Electrochemical Systems (ACE-FUELS) at the Federal University of Technology Owerri, Nigeria. He is a Fellow of the Nigerian Academy of Science and serves as a Faraday Institution Battery Ambassador for Nigeria.\n\nAn internationally recognized scientist, researcher, and academic leader, Professor Oguzie has built an outstanding career in electrochemistry, clean energy technologies, advanced materials, corrosion science, energy storage systems, next-generation solar cells, hydrogen technologies, and circular energy systems. He has authored more than 250 peer-reviewed scientific publications and has supervised over 40 PhD graduates, alongside numerous master's students, researchers, and early-career professionals who are contributing to the advancement of science and technology across Africa and beyond.\n\nThrough ACE-FUELS, Professor Oguzie leads one of Africa's leading clean energy research and capacity-building platforms dedicated to developing the next generation of African scientists, engineers, innovators, and entrepreneurs. The Centre provides advanced postgraduate education, practical laboratory training, access to world-class research infrastructure, international mobility opportunities, industry partnerships, and pathways for technology development and commercialization.\n\nUnder his leadership, ACE-FUELS has established expertise in key future energy technologies including perovskite solar technologies, sodium-ion batteries, redox-flow batteries, green hydrogen systems, electrochemical energy technologies, battery recycling, environmental electrochemistry, and materials degradation. The Centre's work contributes directly to strengthening Africa's technological capacity and accelerating the continent's clean energy transition.\n\nProfessor Oguzie has led and contributed to numerous international research and innovation initiatives involving universities, research institutions, industry partners, and development organizations across Africa, the United Kingdom, Europe, and other regions. His collaborations have focused on printed perovskite solar modules, sodium-ion battery technologies for African mobility and energy access, battery recycling and circular economy value chains, hydrogen technologies, and large-scale clean energy capacity development.\n\nA passionate advocate for Africa's technological transformation, Professor Oguzie believes the continent must move beyond being primarily a supplier of raw materials and a consumer of imported technologies. His work emphasizes sustained investment in young people, research infrastructure, technical skills development, local manufacturing capabilities, innovation ecosystems, and capability-driven international partnerships that enable Africa to become a producer and owner of future energy technologies.\n\nThrough his research leadership, international collaborations, and commitment to scientific excellence, Professor Oguzie continues to play a pivotal role in advancing Africa's battery technologies, clean energy systems, hydrogen economy, and circular energy value chains while empowering a new generation of innovators to shape the continent's sustainable energy future."
},
        ],
      },
    ],
