    ...
    <main className="pt-24 bg-white">
      <section className="relative overflow-hidden border-b border-[#02026e]/20 bg-white">
        <div className="absolute inset-0">
          ...
          <div className="absolute right-[-80px] top-[50px] h-[240px] w-[240px] rounded-full bg-[#02026e]/8 blur-3xl" />
        </div>
              ...
              <form className="grid gap-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <input
                    ...
                    className="h-12 rounded-xl border border-slate-200 bg-slate-50 px-4 text-sm outline-none transition focus:border-[#02026e]/40 focus:bg-white"
                  />
                  <input
                    type="email"
                ...
                <select className="h-12 rounded-xl border border-slate-200 bg-slate-50 px-4 text-sm text-[color:var(--text-main)]-500 outline-none transition focus:border-[#02026e]/40 focus:bg-white">
